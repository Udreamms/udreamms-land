...
async function handleKanbanUpdate(from, contactName, body) {
    ...
    if (existingCardSnapshot.empty) {
        ...
        return Object.assign(Object.assign({}, updatedDoc.data()), { isNew: false });
    }
}
async function createNewCard(contactName, from, body) {
    ...
    return Object.assign(Object.assign({}, newCard.data()), { isNew: true });
}
