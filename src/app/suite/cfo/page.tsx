        ...
        <div className="min-h-screen bg-[#050505] text-white p-8 pt-24">
            <div className="max-w-6xl mx-auto">
                <header className="mb-12">
                    ...
                    >
                        <h6 className="text-amber-500 uppercase tracking-widest text-xs font-bold mb-2">Finance Department</h6>
                        <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white to-white/50 bg-clip-text text-transparent">CFO Office</h1>
