        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="bg-neutral-950 border-neutral-800 text-white sm:max-w-md rounded-2xl p-8 backdrop-blur-2xl">
                ...
                >
                    ...
                    <p className="text-base text-neutral-400 font-semibold mb-1">
                ...
                <div className="mt-4 p-4 bg-neutral-900/50 rounded-xl border border-white/5">
                    <h4 className="text-[10px] font-black uppercase tracking-widest text-blue-500 mb-2">Formato Requerido (CSV)</h4>
                ...
                <DialogFooter className="mt-8">
                    ...
                    <Button onClick={() => (document.querySelector('input[type="file"]') as HTMLInputElement)?.click()} className="bg-blue-600 hover:bg-blue-700 px-8 rounded-xl shadow-lg shadow-blue-600/20 font-bold">Seleccionar Archivo</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    );
