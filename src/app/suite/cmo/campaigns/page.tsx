        ...
        <div className="flex min-h-screen bg-[#0a0a0a] text-white">
            ...
            <div className="flex-1 flex flex-col p-6 space-y-4">
                ...
                <div className="mb-6 flex justify-between items-start">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Campañas Omnicanal</h1>
                        <p className="text-neutral-400 mt-1 text-sm">
                            Lanza campañas masivas inteligentes en segundos.
                        </p>
                    </div>
                    <button className="bg-pink-600 hover:bg-pink-500 px-4 py-1.5 rounded-lg flex items-center gap-2 transition-all shadow-md shadow-pink-600/20 font-bold text-xs mt-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                        ...
                        <div key={i} className={`bg-gradient-to-br ${channel.color} border ${channel.border} p-4 rounded-xl cursor-pointer hover:scale-[1.01] transition-transform`}>
                            ...
                            <h3 className="font-bold text-sm">{channel.label}</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 flex-1">
                    ...
                    <div className="lg:col-span-3 bg-white/5 border border-white/5 rounded-xl flex flex-col p-4">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-sm font-bold flex items-center gap-2 uppercase tracking-wide text-neutral-300"><BarChart3 className="w-4 h-4 text-gray-400" /> Campañas Activas</h2>
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center p-8 space-y-3">
                            ...
                            <div>
                                <p className="text-gray-400 font-bold text-xs uppercase tracking-wide">No hay campañas programadas hoy</p>
                    ...
                    <div className="bg-white/5 border border-white/5 rounded-xl p-4">
                        <h2 className="text-sm font-bold mb-4 flex items-center gap-2 uppercase tracking-wide text-neutral-300"><Users className="w-4 h-4 text-gray-400" /> Audiencias</h2>
                        <div className="space-y-3">
                            <div className="p-3 bg-white/5 rounded-lg border border-white/5">
                                <p className="text-[9px] text-gray-500 uppercase font-black tracking-widest">Total Alcance</p>
                                <p className="text-xl font-bold mt-1">14,240</p>
                                <p className="text-[9px] text-green-400 mt-0.5 flex items-center gap-1 font-bold">↑ 12% desde el mes pasado</p>
                            </div>
                            <div className="space-y-1.5">
                                <p className="text-[9px] text-gray-500 font-black uppercase tracking-wider px-1">Segmentos Top</p>
