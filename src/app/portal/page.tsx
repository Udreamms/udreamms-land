...
export default function PortalPage() {
  ...
  const [activeSection, setActiveSection] = useState<'servicios' | 'productos' | 'curso' | 'libro' | 'experto'>('servicios');
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-purple-500/20 flex flex-col relative overflow-hidden">
      ...
      <header className="sticky top-0 z-40 bg-black/60 backdrop-blur-md border-b border-white/10 h-16 w-full shrink-0">
        <div className="w-full px-4 md:px-8 h-full flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {(['servicios', 'productos', 'curso', 'libro', 'experto'] as const).map((section) => {
              const labelMap = {
                servicios: "Servicios",
                productos: "Productos",
                curso: "Curso",
              ...
              return (
                <button
                  ...
                  className={`relative px-4 py-2 text-xs font-normal tracking-wider uppercase rounded-full transition-all duration-300 ${
                    isActive ? "text-purple-400 bg-white/5" : "text-white/60 hover:text-white hover:bg-white/5"
                  }`}
                >
                  {labelMap[section]}
                  {isActive && (
          ...
          return (
            <button
              ...
              className={`px-4 py-1.5 text-[10px] font-normal tracking-widest uppercase rounded-full shrink-0 transition-all ${
                isActive ? "text-purple-400 bg-transparent border border-purple-500/40" : "text-white/40 border border-transparent"
              }`}
            >
              {labelMap[section]}
            </button>
      ...
      <main className="flex-1 overflow-y-auto relative z-10 py-8 px-4 md:px-8 max-w-7xl mx-auto w-full">
          ...
          >
            ...
            {activeSection === 'servicios' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal tracking-tight">Mis Servicios</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  {/* Status card */}
                  <div className="lg:col-span-2 bg-[#0d0d11]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-8 space-y-8">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <h3 className="text-xl font-normal pt-1">Asesoría de Visa de Estudiante F-1</h3>
                      </div>
                    ...
                    <div className="relative pt-4 pl-4 space-y-8">
                      ...
                      <div className="flex items-start gap-4 relative z-10">
                        ...
                        <div className="space-y-1">
                          <h4 className="text-sm font-normal text-white">Evaluación de Perfil Académico</h4>
                          <p className="text-xs text-white/50">Nuestros expertos están validando tus datos e institución recomendada.</p>
                      ...
                      <div className="flex items-start gap-4 relative z-10">
                        ...
                        <div className="space-y-1 opacity-50">
                          ...
                          <p className="text-xs text-white/50">Llenado y recopilación de documentos financieros y formularios consulares.</p>
                  ...
                  {/* Sidebar card */}
                  <div className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 flex flex-col justify-between space-y-6">
                    <div className="space-y-4">
                      <Shield className="w-6 h-6 text-white" />
                      <h3 className="text-lg font-normal">Asesor Designado</h3>
                      <p className="text-xs text-white/50 leading-relaxed">
                        Tienes soporte de primer nivel asignado para tu trámite. Si tienes preguntas urgentes sobre tus pasos o necesitas cargar documentos, comunícate directamente por el canal preferencial.
                      </p>
                    </div>

                    <Button 
                      onClick={() => setActiveSection('experto')}
            ...
            {activeSection === 'productos' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal tracking-tight">Mis Productos</h2>
                  <p className="text-sm text-white/50">Accede a tus recursos comprados y herramientas de preparación.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 space-y-4 hover:shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all group">
                    ...
                    <div className="space-y-1">
                      <h3 className="text-md font-normal">Guía de Entrevista Consular</h3>
                      <p className="text-xs text-white/50 leading-relaxed">
                  ...
                  <div className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 space-y-4 hover:shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all group">
                    ...
                    <div className="space-y-1">
                      <h3 className="text-md font-normal">Plantilla de Carta de Intención</h3>
                      <p className="text-xs text-white/50 leading-relaxed">
                  ...
                  <div className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 space-y-4 hover:shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all group">
                    ...
                    <div className="space-y-1">
                      <h3 className="text-md font-normal">Checklist de Requisitos Consulares</h3>
                      <p className="text-xs text-white/50 leading-relaxed">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 bg-[#0d0d11] border border-white/5 rounded-3xl overflow-hidden flex flex-col">
                    ...
                    <div className="p-6 space-y-2">
                      <h3 className="text-lg font-normal">Introducción al proceso de visa americana y perfiles</h3>
                      <p className="text-xs text-white/50 leading-relaxed">
            ...
            {activeSection === 'libro' && (
              <div className="space-y-6">
                ...
                <div className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center gap-8 max-w-4xl">
                  {/* Book Mockup cover */}
                  <div className="w-48 h-64 shrink-0 rounded-2xl bg-gradient-to-tr from-[#1b1030] to-[#5b238d] border border-purple-500/30 flex flex-col justify-between p-4 shadow-[0_15px_35px_rgba(168,85,247,0.2)] hover:scale-105 transition-transform duration-300 relative group overflow-hidden">
                    ...
                    <div className="space-y-1 z-10">
                      <h4 className="text-md font-normal leading-tight text-white">TU SUEÑO EN</h4>
                      <h4 className="text-2xl font-normal tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-purple-200 to-white">AMÉRICA</h4>
                      <p className="text-[9px] text-white/50 pt-1">Guía indispensable para tu viaje y estadía</p>
                    </div>
                  ...
                  <div className="space-y-6 text-center md:text-left flex-1">
                    <div className="space-y-2">
                      <h3 className="text-xl md:text-2xl font-normal">Tu Sueño en América: Guía de Sobrevivencia Consular</h3>
