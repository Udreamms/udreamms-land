          ...
          <div className="container mx-auto px-6 md:px-12 max-w-[1400px]">
            <div className="max-w-4xl text-left">
              <motion.span 
                ...
                className="text-indigo-600 font-bold tracking-tight text-xl mb-4 block"
              >
                Partnerships
              </motion.span>
          ...
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
               ...
               <div className="space-y-12">
                  <div>
                    <h2 className="text-3xl font-black text-[#1d1d1f] mb-6">¿Por qué aliarse con Udreamms?</h2>
                  ...
                  <div className="space-y-8">
                     {[
                       ...
                       <div key={idx} className="flex gap-6">
                          ...
                          <div>
                             <h4 className="text-xl font-bold text-[#1d1d1f] mb-1">{item.title}</h4>
               ...
               >
                  <form className="space-y-6">
                    <div className="space-y-2">
                      <Label className="text-xs font-bold uppercase tracking-widest text-[#86868b] ml-1">Nombre de la Organización</Label>
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs font-bold uppercase tracking-widest text-[#86868b] ml-1">Persona de Contacto</Label>
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs font-bold uppercase tracking-widest text-[#86868b] ml-1">Email Corporativo</Label>
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs font-bold uppercase tracking-widest text-[#86868b] ml-1">Mensaje</Label>
                      <Textarea 
                    ...
                    <Button className="w-full h-14 rounded-full bg-[#1d1d1f] hover:bg-[#333] text-white font-bold text-lg transition-all shadow-xl hover:shadow-2xl mt-4">
                      Enviar Solicitud
