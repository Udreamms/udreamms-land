    ...
    return (
        <section className="py-20 bg-cloud relative overflow-hidden">
            <div className="container mx-auto px-6">
                <FadeIn>
                    <div className="max-w-4xl mx-auto bg-abyss rounded-[3rem] p-12 md:p-16 text-center relative overflow-hidden shadow-2xl">
                        {/* Background Accent */}
                        ...
                        <div className="relative z-10">
                            ...
                            <Button
                                ...
                                className="bg-white hover:bg-slate-100 text-abyss text-xl px-12 py-8 rounded-full shadow-xl transition-all hover:scale-105 font-bold group"
                            >
                                <ShoppingCart className="mr-3 w-6 h-6 text-blue-600 group-hover:scale-110 transition-transform" />
                                Comprar mi Plan de Visa
                            </Button>

                            <p className="mt-8 text-sm text-gray-400 font-semibold tracking-widest uppercase">
