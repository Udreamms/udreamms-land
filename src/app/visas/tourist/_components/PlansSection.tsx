                        ...
                        {PLANS.map((plan, index) => (
                            <ScaleIn delay={index * 0.1} key={index} className="h-full">
                                ...
                                `}>
                                    ...
                                    <div className="absolute top-6 right-6 bg-slate-200 text-slate-800 px-3 py-1.5 rounded-md text-sm font-medium tracking-wide shadow-sm transform rotate-2">
                                        30% OFF
                                    </div>
                                    ...
                                    <div className="mb-8 mt-12">
                                        <h3 className={`text-2xl font-medium mb-2 tracking-tight ${plan.highlight ? "text-slate-900" : "text-slate-700"}`}>
                                            {plan.name}
                                        </h3>
                                        ...
                                        <div className="flex flex-col items-start mb-4">
                                            ...
                                            <div className="flex items-baseline gap-1">
                                                <span className="text-4xl font-medium text-slate-900 tracking-tighter">{plan.price}</span>
                                            </div>
                                        </div>
                                    ...
                                    <Button
                                        className="w-full mb-10 rounded-full py-6 font-medium text-lg shadow-lg transition-all duration-300 active:scale-95 border-2 bg-white text-slate-900 border-slate-200 hover:bg-slate-900 hover:text-white hover:border-slate-900"
                                    >
                                        Elegir Plan
                                    </Button>

                                    <div className="space-y-6 flex-grow">
                                        <p className="font-medium text-sm text-slate-900 mb-6 uppercase tracking-widest border-b border-slate-100 pb-2">
                                            LO QUE INCLUYE:
                                        </p>
