    ...
    return (
        <section id="quiz" className="py-24 bg-black text-center px-6 relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto relative z-10">
                <FadeIn>
                    <h2 className="text-4xl md:text-6xl font-black mb-8 italic leading-none text-white">
                    ...
                    <div className="bg-zinc-900/50 p-8 rounded-2xl border border-white/10 backdrop-blur-md mb-8">
                        <div className="flex flex-col gap-4 mb-8 text-left max-w-lg mx-auto">
                            <div className="flex items-center gap-3 text-lg text-gray-300">
                                <Check className="text-green-500 w-6 h-6 shrink-0" /> <span className="font-bold">Activación Inmediata del Radar</span>
                            </div>
                            <div className="flex items-center gap-3 text-lg text-gray-300">
                                <Check className="text-green-500 w-6 h-6 shrink-0" /> <span className="font-bold">Acceso a la Comunidad "Mundialistas"</span>
                            </div>
                            <div className="flex items-center gap-3 text-lg text-gray-300">
                                <Check className="text-green-500 w-6 h-6 shrink-0" /> <span className="font-bold">Guía de Sedes 2026 de regalo</span>
                            </div>
                        </div>
                        ...
                        <a
                            ...
                            className="block w-full bg-[#25D366] hover:bg-[#1efc76] text-black font-black py-6 rounded-2xl text-xl md:text-2xl transition-all shadow-[0_0_40px_rgba(37,211,102,0.3)] hover:scale-[1.02] flex items-center justify-center gap-3"
                        >
