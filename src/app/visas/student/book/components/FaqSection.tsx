  ...
  return (
    <section className="w-full bg-black py-24 md:py-32 px-4 md:px-8 lg:px-12 font-sans flex flex-col items-center relative overflow-hidden">
      <div className="w-full px-4 md:px-16 lg:px-[190px] flex flex-col items-center font-sans">
        <h2 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight leading-tight text-center font-sans">
          Preguntas Frecuentes
        </h2>

        <div className="w-full mt-10 space-y-6 font-sans text-left">
          {/* FAQ Item 1 */}
          <div className="bg-slate-900/40 border border-white/5 rounded-2xl p-6 shadow-lg flex flex-col font-sans">
            <h3 className="text-lg md:text-xl font-bold text-white font-sans flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-400 font-bold text-sm">?</span>
              ¿Qué es el libro digital de Udreamms y para qué sirve?
            </h3>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed mt-3 pl-9 font-sans">
