...
export default function PromoCtaSection() {
  return (
    <section className="w-full bg-black py-16 px-4 md:px-8 lg:px-12 font-sans border-b border-white/10 text-white flex flex-col items-center justify-center text-center relative overflow-hidden">
