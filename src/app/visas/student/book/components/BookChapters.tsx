    ...
    <section className="w-full bg-[#f8fafc] py-24 md:py-32 px-4 md:px-8 lg:px-12 font-sans border-b border-slate-100">
      <div className="w-full px-4 md:px-16 lg:px-[190px] flex flex-col font-sans">
        ...
        <div className="text-center md:text-left flex flex-col space-y-4 font-sans">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#0f2d59] tracking-tight leading-tight font-sans">
        ...
        {/* Chapter 1 Card */}
        <div className="w-full bg-white border border-slate-100 rounded-3xl p-6 md:p-10 shadow-lg mt-10 font-sans">
          <span className="text-[#3b82f6] font-bold text-sm tracking-wider uppercase font-sans">
            Capítulo 1
          </span>
          <h4 className="text-2xl md:text-3xl font-extrabold text-[#0f2d59] mt-2 font-sans">
          ...
          <div className="mt-8 space-y-8 font-sans">
            ...
            <div className="flex flex-col font-sans">
              <div className="flex items-start gap-3 font-sans">
                <span className="flex-shrink-0 w-2.5 h-2.5 rounded-full bg-blue-600 mt-2.5" />
                <h5 className="text-lg md:text-xl font-bold text-[#0f2d59] font-sans">
                  ¿Cómo encontrar una institución acreditada para emitir una visa F1?
                </h5>
              </div>
              <p className="text-sm md:text-base text-slate-600 leading-relaxed mt-2 pl-5 font-sans">
            ...
            <div className="flex flex-col font-sans">
              <div className="flex items-start gap-3 font-sans">
                ...
                <h5 className="text-lg md:text-xl font-bold text-pink-600 font-sans">
