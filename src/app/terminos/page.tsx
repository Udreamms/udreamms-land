          ...
          <div className="container mx-auto px-6 md:px-12 max-w-[1400px]">
            <div className="max-w-4xl text-left">
              ...
              <motion.div 
                ...
                className="mt-8 text-sm font-bold text-slate-400 uppercase tracking-widest"
              >
          ...
          <div className="container mx-auto px-6 md:px-12 max-w-4xl">
            <div className="space-y-20">
              ...
              <div className="bg-amber-50 border-2 border-amber-100 p-8 md:p-12 rounded-[3rem] relative overflow-hidden">
                <div className="relative z-10">
                   <div className="flex items-center gap-4 mb-6">
                      ...
                      <h2 className="text-2xl font-black text-amber-900 uppercase tracking-wider">Descargo Legal Importante</h2>
                   </div>
              ...
              <div className="space-y-8">
                <h2 className="text-3xl font-black text-[#1d1d1f] tracking-tight flex items-center gap-4">
                  <span className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-primary text-sm font-bold shadow-sm">02</span>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 p-4 rounded-2xl border border-slate-100 bg-slate-50 text-slate-700 font-bold">
              ...
              <div className="space-y-8">
                 <h2 className="text-3xl font-black text-[#1d1d1f] tracking-tight flex items-center gap-4">
                  <span className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-primary text-sm font-bold shadow-sm">03</span>
                  Pagos y Reembolsos
                </h2>
              ...
              <div className="bg-[#1d1d1f] text-white p-10 md:p-16 rounded-[3.5rem] relative overflow-hidden">
                ...
                <div className="relative z-10">
                   <h2 className="text-3xl font-black mb-6 tracking-tight flex items-center gap-4">
