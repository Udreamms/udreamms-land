          ...
          <div className="container mx-auto px-6 md:px-12 max-w-[1400px]">
            <div className="max-w-4xl text-left">
              <motion.span
                ...
                className="text-emerald-600 font-medium tracking-tight text-xl mb-4 block"
              >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                >
                  ...
                  <h3 className="text-2xl font-medium text-[#1d1d1f] mb-4">{item.title}</h3>
          ...
          <div className="container mx-auto px-6 max-w-3xl">
            <div className="bg-white rounded-[3.5rem] p-8 md:p-16 shadow-sm border border-slate-100">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-medium text-[#1d1d1f] tracking-tight">Formulario de Referido</h2>
                <p className="text-[#86868b] font-medium mt-2">Ingresa los datos para registrar tu recomendación</p>
              </div>

              <form className="space-y-8">
                <div className="space-y-6">
                  <h4 className="text-xs font-medium uppercase tracking-[0.2em] text-[#1d1d1f] border-b border-slate-100 pb-2">Tus Datos (Referidor)</h4>
                ...
                <div className="space-y-6">
                  <h4 className="text-xs font-medium uppercase tracking-[0.2em] text-[#1d1d1f] border-b border-slate-100 pb-2">Datos de tu Amigo (Referido)</h4>
                  <div className="grid md:grid-cols-2 gap-4">
                ...
                <Button className="w-full h-16 rounded-full bg-[#1d1d1f] hover:bg-[#333] text-white font-medium text-xl transition-all shadow-xl hover:shadow-2xl mt-4">
                  Registrar Referido
