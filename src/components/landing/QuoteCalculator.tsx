        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            ...
            {step === 1 && (
              <div className="space-y-8">
                <div className="text-center">
                  <h2 className="text-3xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">Selecciona tu Destino</h2>
                  <p className="text-gray-400">Elige la institución que será tu puerta de entrada a USA</p>
                </div>
            ...
            {step === 2 && (
              <div className="space-y-8">
                <div className="text-center">
                  <h2 className="text-3xl font-bold mb-2 text-white">Elige tu Programa</h2>
                  <p className="text-gray-400">¿Cuál es tu objetivo académico?</p>
                </div>
                  ...
                  {getAvailablePrograms().map((program) => (
                    ...
                    >
                      <div className="flex items-center justify-between w-full">
                        <div className="text-left">
                          <h3 className="font-bold text-white mb-1">{program.name}</h3>
                          <p className="text-sm text-gray-400">{program.description}</p>
                          <span className="inline-block mt-2 text-[10px] font-bold px-2 py-0.5 rounded bg-white/10 text-blue-200 border border-white/5">
                            {program.level}
                          </span>
                        </div>
                ...
                {quoteData.program === "Inglés Intercultural" && (
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-6">
                    <div>
                      <h4 className="text-sm font-bold text-purple-300 uppercase tracking-wider mb-3">Duración</h4>
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-blue-300 uppercase tracking-wider mb-3">Ubicación</h4>
                      <div className="flex flex-wrap gap-3">
            ...
            {step === 3 && (
              <div className="space-y-8">
                 <div className="text-center">
                  <h2 className="text-3xl font-bold mb-2 text-white">¿Quién viaja contigo?</h2>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    <div className="text-center py-4">
                       ...
                       <h3 className="font-bold text-lg mb-1">Viajo Solo</h3>
                       <p className="text-xs text-gray-400">Visa F1 Individual</p>
                    </div>
                  </SelectionCard>
                  ...
                  >
                    <div className="text-center py-4">
                       ...
                       <h3 className="font-bold text-lg mb-1">Viajo en Familia</h3>
                       <p className="text-xs text-gray-400">Visa F1 + Dependientes F2</p>
                    </div>
                  </SelectionCard>
                </div>
            ...
            {step === 4 && (
              <div className="space-y-8">
                 <div className="text-center">
                  ...
                  <h2 className="text-3xl font-bold mb-2 text-white">Servicio de Aeropuerto</h2>
                  <p className="text-gray-400">Llegada VIP en Utah</p>
                </div>
                ...
                <div className="grid gap-4">
                   <SelectionCard selected={quoteData.airportService} onClick={() => setQuoteData({...quoteData, airportService: true})}>
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <h3 className="font-bold">Sí, quiero que me recojan</h3>
                   ...
                   <SelectionCard selected={!quoteData.airportService} onClick={() => setQuoteData({...quoteData, airportService: false})}>
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <h3 className="font-bold">No, gracias</h3>
            ...
            {step === 5 && (
               ...
               <div className="text-center">
                ...
                <h2 className="text-3xl font-bold mb-2 text-white">Búsqueda de Vivienda</h2>
                <p className="text-gray-400">Evita estafas y asegura tu hogar antes de viajar</p>
              </div>
              ...
              <div className="grid gap-4">
                 <SelectionCard selected={quoteData.housingService} onClick={() => setQuoteData({...quoteData, housingService: true})}>
                    <div className="flex items-center gap-4">
                      <div className="bg-green-500/20 p-2 rounded-lg text-green-400"><Check className="w-5 h-5"/></div>
                      <div className="text-left">
                        <h3 className="font-bold">Sí, ayúdenme a buscar</h3>
            ...
            {step === 6 && (
              <div className="space-y-6">
                <div className="text-center">
                  <h2 className="text-3xl font-bold mb-2">Resumen de Inversión</h2>
                      ...
                      {isInterculturalProgram ? (
                        <>
                           <div className="flex justify-between items-center border-b border-dashed border-gray-300 pb-4">
                              <span className="font-bold text-lg">Programa Todo Incluido</span>
                              <span className="font-black text-xl">${getProgramPrice()}</span>
                           </div>
                        ...
                        <>
                           ...
                           <div className="pt-4 mt-4 border-t-2 border-dashed border-gray-300">
                             <div className="flex justify-between items-center">
                               <span className="font-bold text-gray-500">Inversión Total Estimada</span>
              ...
              <div className="space-y-8 max-w-md mx-auto">
                 {!showCheckout ? (
                   <div className="text-center space-y-6">
                      ...
                      <h2 className="text-4xl font-black text-white">¡Ahorra $80 USD!</h2>
                      <p className="text-gray-300">Si inicias tu proceso hoy, te descontamos $80 de los servicios de Udreamms.</p>
                      ...
                      <Button 
                        ...
                        className="w-full h-14 text-lg font-bold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 shadow-[0_0_30px_rgba(37,99,235,0.5)] border-0"
                      >
                        Reclamar Descuento
                      </Button>
                   ...
                   <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
                      ...
                      <form onSubmit={handleCheckout} className="space-y-4">
                        ...
                        <Button type="submit" size="lg" className="w-full mt-6 bg-green-600 hover:bg-green-500 text-white font-bold h-12">
