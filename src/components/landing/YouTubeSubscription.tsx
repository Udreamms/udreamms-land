      ...
      <div className="container px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a 
            ...
            className="inline-flex items-center justify-center px-10 py-5 text-lg font-semibold bg-white text-primary rounded-lg shadow-2xl hover:scale-105 transition-all hover:shadow-[0_20px_60px_-10px_rgba(255,255,255,0.5)] group"
          >
          ...
          <div className="mt-8 flex items-center justify-center gap-8 text-white/80">
            ...
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-white/80 rounded-full animate-pulse" style={{ animationDelay: '0.3s' }} />
              <span className="text-sm font-medium">Testimonios</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-white/80 rounded-full animate-pulse" style={{ animationDelay: '0.6s' }} />
