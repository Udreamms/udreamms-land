...
const paths = [
  {
    ...
    features: [
      ...
      { text: "Optimización DS-160 AI", icon: FileCheck, desc: "Redacción estratégica sin errores." },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mx-auto">
          {paths.map((path, index) => (
            <div key={index} className="relative group w-full flex flex-col">
              ...
              {/* Glow Effect Background - Now uniform and centered */}
              ...
              {/* Card Content */}
              <div className="relative flex-1 bg-black/60 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-10 flex flex-col ring-1 ring-white/5 shadow-2xl overflow-hidden">
                ...
                <div className="mb-12 text-center">
                  <p className="text-slate-500 text-sm line-through decoration-slate-600 mb-2 font-normal">{path.oldPrice} USD</p>
                  <div className="flex items-baseline justify-center gap-2">
                    <span className="text-7xl font-normal text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-500 tracking-tighter">
                      {path.price}
                    </span>
                    <span className="text-2xl text-slate-400 font-normal">USD</span>
                  </div>
                </div>
