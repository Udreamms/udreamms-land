...
export const LiveChatButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-black/40 hover:bg-black/60 backdrop-blur-md text-white px-5 py-3 rounded-full transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 group cursor-pointer border border-white/10 shadow-lg"
    >
